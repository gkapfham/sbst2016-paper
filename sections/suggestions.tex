...
such as ``testthat'' to write test cases that establish a confidence in the correctness of their functions for data
transformation, statistical analysis, and graphing.
