...
like ``testthat'' to implement and run test cases for their transformation and analysis functions.

% for data transformation, statistical analysis, and graphing.
