...
\newcommand{\pvalues}{{\it p}-values\xspace}
...
\newcommand{\codeforkgit}{\faCodeFork~in \faGithubAlt}
\newcommand{\codecopygit}{\faCopy~in \faGit}
\newcommand{\codeeditgit}{\faCode~+~\faEdit~in \faGit}
