...
\begin{figure*}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[node distance = 10em, auto]
      ...
      \path [dashed-line] (atdg-report) -- (compiler);
      \path [dashed-line] (atsp-report) -- (compiler);
      \path [dashed-line] (compiler) -- (atdg-report-result);
      \path [dashed-line] (compiler) -- (atsp-report-result);
