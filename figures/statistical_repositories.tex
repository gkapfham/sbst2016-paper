...
\begin{figure*}
  ...
  \begin{center}
    ...
    \begin{tikzpicture}[thick,scale=0.925, every node/.style={scale=0.925}, node distance=10em, auto]
    % \begin{tikzpicture}[node distance = 10em, auto]
      ...
      \node [paper-atsp, below of=markdown-compiler, yshift=2em] (ssbse-paper) {SBST Paper\\ \vspace*{.25em} \faCode~+~\faEdit~in \faGit};
      ...
      \path [single-line] (1.75,-3.5) -- (2.75,-3.5) node[draw=none,fill=none,font=\scriptsize,midway,below] {Fork, clone, or copy};
