...
\begin{figure*}
  ...
  \begin{center}
    ...
    \tikzstyle{repository-atsp} = [rectangle, draw, thick, double, fill=gray!50, text width=7em, text centered, rounded corners, minimum height=4em]
    ...
    \begin{tikzpicture}[node distance = 10em, auto]
      ...
      \node [repository-atdg, right of=sbst-analysis] (atdg-analysis) {atdg-analysis \\ \faGithub~or \faGit};
      \node [repository-atsp, below of=atdg-analysis] (atsp-analysis) {atsp-analysis \\ \faGithub~or \faGit};
